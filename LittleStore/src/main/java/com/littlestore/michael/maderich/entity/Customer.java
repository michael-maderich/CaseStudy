...
/* Customer Entity holds all customer data, including name, email, password, street address, payment type and payment handle
* States and payment types are held in enums
* */
@Entity
@Table(name="customer")
